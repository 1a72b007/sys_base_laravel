...
``` bash
# clone the repo
$ git clone https://git.acubedt.com:7000/roy/sys_base_laravel.git sys_base_laravel
...
Then go to `sys_base_laravel/.env`
...
`sys_base_laravel/database/seeds/MenusTableSeeder.php`
